...
export function Rankings({ albums, isAdmin = false }) {
  ...
  // 👈 FUNCIÓN CORREGIDA - Acepta el máximo como parámetro
                  ...
                  {podiumAlbums.length > 0 && (
                    <div className="mb-8">
                      <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
                        {/* 1er Lugar */}
                        {podiumAlbums[0] && (
                          <div className="w-full md:w-2/5 max-w-[340px] order-1 md:order-1">
                            <div className="relative bg-gradient-to-br from-yellow-400/20 to-yellow-600/20 border-2 border-yellow-400/30 rounded-2xl p-6 text-center hover:scale-105 transition-transform duration-300 shadow-2xl shadow-yellow-500/20">
                              ...
                              <div className="relative mx-auto w-2xl h-2xl sm:w-3xl sm:h-3xl">
                        ...
                        {/* 2do Lugar */}
                        {podiumAlbums[1] && (
                          <div className="w-full md:w-1/3 max-w-[280px] order-2 md:order-2 md:translate-y-4">
                            <div className="relative bg-gradient-to-br from-gray-300/20 to-gray-400/20 border border-gray-300/30 rounded-2xl p-5 text-center hover:scale-105 transition-transform duration-300 shadow-lg shadow-gray-400/20">
                              <div className="text-4xl mb-2 animate-bounce">
                                🥈
                              </div>

                              <div className="relative mx-auto w-xl h-xl sm:w-2xl sm:h-2xl">
                        ...
                        {/* 3er Lugar */}
                        {podiumAlbums[2] && (
                          <div className="w-full md:w-1/4 max-w-[240px] order-3 md:order-3 md:translate-y-8">
                            <div className="relative bg-gradient-to-br from-amber-600/20 to-amber-700/20 border border-amber-600/30 rounded-2xl p-4 text-center hover:scale-105 transition-transform duration-300 shadow-lg shadow-amber-600/20">
                              ...
                              <div className="relative mx-auto w-lg h-lg sm:w-xl sm:h-xl">
                              ...
                              <div className="mt-2">
                                <span className="text-[#f5576c] text-lg font-bold">
                                  ★{' '}
                                  {formatRating(
                  ...
                  {topReviewers.map((reviewer, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-2">
                          {/* 👈 Reviewers siempre usan máximo 10 */}
                          {renderRatingBar(
