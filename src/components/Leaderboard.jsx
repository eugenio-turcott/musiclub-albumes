...
export const BADGES_GUIDE = [
  {
    category: '🏆 Reconocimientos Principales',
    icon: '👑',
    description:
      'Insignias de honor por liderazgo en actividad, aportes y detalle de evaluación.',
    badges: [
      {
        ...
        desc: 'Líder del club con el mayor número de reseñas publicadas en la comunidad.',
      },
      {
        label: '🌟 Gran Curador',
        color: 'from-purple-500 via-fuchsia-500 to-violet-600',
        textColor: 'text-white',
        req: 'Récord #1 en Álbumes',
        desc: 'Mayor aportador de álbumes compartidos para las escuchas del club.',
      },
      {
        label: '⚡ Pistas al Detalle',
        color: 'from-cyan-400 via-teal-400 to-cyan-500',
        textColor: 'text-cyan-950',
        req: '≥ 25 tracks calificados',
        desc: 'Se toma el tiempo de evaluar minuciosamente canción por canción pista a pista.',
      },
    ],
  },
  {
    category: '🎯 Estilo y Rigor de Evaluación',
    icon: '✨',
    description:
      'Distinciones por personalidad crítica, redacción de opiniones y calificaciones destacadas.',
    badges: [
      {
        ...
        textColor: 'text-white',
        req: 'Promedio ≤ 7.2 ⭐',
        desc: 'Estándares rigurosos y análisis estricto. Difícil de complacer.',
      },
      {
        ...
        req: 'Promedio ≥ 8.6 ⭐',
        desc: 'Gran aprecio por el arte musical y valoraciones entusiastas.',
      },
      {
        label: '✍️ Pluma Crítica',
        color: 'from-blue-500 via-indigo-500 to-blue-600',
        textColor: 'text-white',
        req: '≥ 2 reseñas con comentario',
        desc: 'Escribe análisis y opiniones detalladas en texto para el debate musical.',
      },
      {
        label: '💯 Cazador del 10',
        color: 'from-pink-500 via-rose-400 to-pink-600',
        textColor: 'text-white',
        req: 'Haber otorgado un 10 ⭐',
        desc: 'Ha encontrado la perfección y otorgado nota 10 a un disco o canción.',
      },
    ],
  },
];
