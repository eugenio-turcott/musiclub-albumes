    ...
    <div className="mt-8 pt-6 border-t border-white/5">
      ...
      >
        <input
          ...
          className="flex-1 bg-black/30 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder-white/20 focus:outline-none focus:border-[#f5576c]/50 transition-colors"
        />
        <button
          type="submit"
          disabled={loading}
          className="px-6 py-2.5 bg-gradient-to-r from-[#f5576c] to-[#f093fb] text-white rounded-xl text-sm font-bold hover:scale-[1.02] transition-all disabled:opacity-50 whitespace-nowrap shadow-lg shadow-[#f5576c]/20"
        >
        ...
        <div className="bg-gradient-to-br from-blue-500/5 to-cyan-500/5 rounded-2xl p-4 border border-blue-500/20">
          ...
          <div className="mt-3 bg-blue-500/5 border border-blue-500/10 rounded-xl p-3">
            <p className="text-white/40 text-xs flex items-center gap-2">
              ...
              Este álbum es <span className="text-white/60">Individual</span> y
              no participa en la máquina musical. Puedes dejar tu review aquí.
